...
public class CreateRequestForm {
	...
	public CreateRequestForm(long userId, String equipmentCategory, double equipmentLength, double equipmentWidth,
							 double equipmentHeight, long equipmentQuantity, String typeOfTransporting,
							 double capacityOfTransport, boolean rentalByTrip, double rentalDuration,
							 int startLocationPostalCode, int endLocationPostalCode, float routeDistance,
